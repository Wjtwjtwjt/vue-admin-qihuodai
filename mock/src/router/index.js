  ...
  // 系统设置
  {
    ...
    children: [
      ...
      },
      {
        path: 'addprotocol',
        name: 'addprotocol',
        component: () => import('@/views/system/addprotocol'),
        hidden:true,
        meta: { title: '新增协议' },
      },
      {
        path: 'editprotocol',
        name: 'editprotocol',
        component: () => import('@/views/system/editprotocol'),
        hidden:true,
        meta: { title: '修改协议' },
      },
      {
...
// 合约管理
{
  ...
  children: [
    ...
    },
    {
      path: 'editlist',
      name: 'editlist',
      component: () => import('@/views/contract/editlist'),
      hidden:true,
      meta: { title: '修改合约' },
    },
    {
    ...
    },
    {
      path: 'addbourse',
      name: 'addbourse',
      component: () => import('@/views/contract/addbourse'),
      hidden:true,
      meta: { title: '添加交易所' },
    },
    {
      path: 'editbourse',
      name: 'editbourse',
      component: () => import('@/views/contract/editbourse'),
      hidden:true,
      meta: { title: '修改交易所' },
    },
    {
    ...
    },
    {
      path: 'addcurrency',
      name: 'addcurrency',
      component: () => import('@/views/contract/addcurrency'),
      hidden:true,
      meta: { title: '添加币种' },
    },
  ]
...
// 用户管理
{
  ...
  children: [
    ...
    },
    {
      path: 'edituserlist',
      name: 'edituserlist',
      component: () => import('@/views/users/edituserlist'),
      hidden:true,
      meta: { title: '用户列表' },
    },
    {
...
// 其他设置
{
  ...
  children: [
    ...
    },
    {
      path: 'addguide',
      name: 'addguide',
      component: () => import('@/views/sett/addguide'),
      hidden:true,
      meta: { title: '添加指引' },
    },
    {
    ...
    },
    {
      path: 'addbackcard',
      name: 'addbackcard',
      component: () => import('@/views/sett/addbackcard'),
      hidden:true,
      meta: { title: '增加银行卡' },
    },
    {
      path: 'editbackcard',
      name: 'editbackcard',
      component: () => import('@/views/sett/editbackcard'),
      hidden:true,
      meta: { title: '修改银行卡' },
    },
  ]
