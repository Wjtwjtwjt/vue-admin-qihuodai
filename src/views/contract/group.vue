<template>
  <div class="group">
    ...
    >
      ...
      <el-table-column label="组别名称" prop="name"></el-table-column>
      <el-table-column label="简介" prop="name"></el-table-column>
      <el-table-column label="创建时间" prop="name"></el-table-column>
      <el-table-column label="操作">
        <template slot-scope="scope" width="200">
          <el-button size="mini"><router-link to="./editgroup">编辑</router-link></el-button>
